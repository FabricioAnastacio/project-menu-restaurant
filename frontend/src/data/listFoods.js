...
const listFoods = {
  food: [
    ...
    },
    {
      ...
      ingredients: ['Pão', ' Bife 90g', ' Frango desfiado', ' Requeijão cremoso', ' Calabresa', ' Cebola roxa', ' Mussarela', ' Salada', ' Milho e batata'],
      value: 25.00,
      amount: 0,
    },
    {
    ...
    },
    {
      ...
      ingredients: ['Pão', ' 2 Bifes 90g', ' Frango desfiado', ' Requeijão cremoso', ' 2 Ovos', ' Bacon', ' Presunto', ' Mussarela', ' Cebola roxa', ' Salada', ' Milho e batata'],
      value: 30.00,
      amount: 0,
    },
    {
