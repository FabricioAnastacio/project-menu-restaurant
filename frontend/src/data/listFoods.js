...
const listFoods = {
  food: [
    ...
    },
    {
      ...
      ingredients: ['Pão brioche', ' Blend bovino de 120g', ' Cheddar', ' Bacon fatiado e', ' Molho especial', ' (ACOMPANHA FRITAS POKÊ 150G)'],
      value: 25.00,
      amount: 0,
    },
    {
      ...
      ingredients: ['Pão brioche', ' Blend bovino de 120g', ' Mussarela', ' Cheddar', ' Bacon fatiado', ' Cebola roxa e', ' Molho especial', ' (ACOMPANHA KATANA BATATA 150G)'],
      value: 27.00,
      amount: 0,
    },
    {
